...
//         {/* Contact information as in the original code */}
//       </div>
...
//               className="px-2 pt-3 bg-transparent text-gray-200 font-medium w-full text-sm border-b border-gray-400 focus:border-yellow-300 outline-none"
//             ></textarea>
//             {errors.message && <p className="text-red-500 text-xs">{errors.message}</p>}

//             <button
//               type="submit"
//               className="px-6 py-3 mt-6 text-white bg-yellow-300 rounded-full hover:bg-yellow-400"
//             >
//               Send Message
//             </button>
//           </div>
