                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div className="flex flex-col items-start">
                        ...
                        <p className="mt-4 text-gray-500">
                            Discover the power of nature with R D Organic – your
                            one-stop solution for premium beauty and hair care products.
                        </p>
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-gray-500">
                            Sign up to receive exclusive offers, the latest updates on new products, 
                            and natural beauty tips straight to your inbox.
                        </p>
                    </div>
                </div>
